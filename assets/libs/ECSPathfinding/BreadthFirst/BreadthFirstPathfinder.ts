...
export class BreadthFirstPathfinder {
    public static search<T extends Vector2>(graph: IUnweightedGraph<T>, start: T, goal: T, cameFrom: Map<string, T> = new Map<string, T>()): boolean {
        let foundPath = false;
        let frontier = [];
    ...
    public static searchR<T extends Vector2>(graph: IUnweightedGraph<T>, start: T, goal: T) {
