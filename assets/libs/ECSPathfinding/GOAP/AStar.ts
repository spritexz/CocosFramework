...
import { ListPool } from "../../ECSEngine/Utils/Collections/ListPool";
import { IPoolable, Pool } from "../../ECSEngine/Utils/Collections/Pool";
import { IEquatable } from "../../ECSEngine/Utils/IEquatable";
import { Action } from "./Action";
import { ActionPlanner } from "./ActionPlanner";
import { AStarStorage } from "./AStarStorage";
...
export class AStar {
    ...
    public static plan(ap: ActionPlanner, start: WorldState, goal: WorldState, selectedNodes: AStarNode[] = null) {
        ...
        while (true) {
            ...
            ListPool.free<AStarNode>(AStarNode, neighbors);
        }
    }
