...
import { ICoroutine } from "./Utils/Coroutines/Coroutine";
import { CoroutineManager } from "./Utils/Coroutines/CoroutineManager";
...
export class Core {
    ...
    public static unregisterGlobalManager(manager: GlobalManager) {
        new List(this._instance._globalManagers).remove(manager);
