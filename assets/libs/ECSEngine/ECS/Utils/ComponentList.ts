...
import { TypeUtils } from "../../Utils/Extensions/TypeUtils";
import { List } from "../../Utils/Linq/list";
import { Component } from "../Component";
import { IUpdatableComparer, IUpdatable, isIUpdatable } from "../Components/IUpdatable";
import { RenderableComponent } from "../Components/Renderables/RenderableComponent";
...
export class ComponentList {
    ...
    private componentsByType = new Map<new (...args: any[]) => Component, Component[]>();
    private componentsToAddByType = new Map<new (...args: any[]) => Component, Component[]>();
        ...
        if (this._components.length > 0) {
            for (let i = 0, s = this._components.length; i < s; ++i) {
                ...
                if (isIUpdatable(component))
                    new List(this._updatableComponents).remove(component);
