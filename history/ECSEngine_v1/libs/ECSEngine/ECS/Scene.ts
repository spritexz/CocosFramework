...
import { DefaultRenderer } from "../Graphics/Renderers/DefaultRenderer";
...
import { RenderableComponentList } from "./Utils/RenderableComponentList";
...
export class Scene {
    ...
    public removeSceneComponent(component: SceneComponent) {
        const sceneComponentList = new List(this._sceneComponents);
    ...
    public addEntity(entity: Entity) {
        Insist.isFalse(new List(this.entities.buffer).contains(entity), `您试图将同一实体添加到场景两次: ${entity}`);
