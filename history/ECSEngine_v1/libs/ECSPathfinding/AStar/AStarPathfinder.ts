...
export class AStarPathfinder {
     ...
     * @param goal
     */
    public static search<T extends Vector2>(graph: IAstarGraph<T>, start: T, goal: T, cameFrom: Map<string, T> = new Map<string, T>()) {
        let foundPath = false;
     ...
     * @param goal 
     */
    public static searchR<T extends Vector2>(graph: IAstarGraph<T>, start: T, goal: T) {
 ...
 */
class AStarNode<T extends Vector2> extends PriorityQueueNode {
    public data: T;
